...
const TopPerformers = ({topPerformersPercentage, topPerformersAverageSales}) => (
        ...
        <div className="card rounded-custom fs-3">
            <div className="card-body p-0">
                <div className="fs-3 d-flex flex-row bd-highlight justify-content-between p-4 border-bottom">
                    ...
                    <p className="mb-0">{topPerformersPercentage}</p>
                </div>
                <div className="fs-3 d-flex flex-row bd-highlight justify-content-between p-4 border-bottom">
                    <p className="mb-0">Average Monthly Sales</p>
                    <p className="mb-0">{formatCurrencyWithSymbol(topPerformersAverageSales)}</p>
                </div>
            </div>
        </div>
    </section>
